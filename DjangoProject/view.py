...
def picture(request):
    articles = Article.objects.filter(status=1, classify=4).order_by('-id')
...
def renWu(request):
    articles = Article.objects.filter(status=1, classify=3).order_by('-id')
    hot_spots = Article.objects.filter(status=1).order_by('-id')[:5]
...
def xiaoYuan(request):
    articles = Article.objects.filter(status=1, classify=2).order_by('-id')
    hot_spots = Article.objects.filter(status=1).order_by('-id')[:5]
    data = {'articles': articles, 'hot_spots': hot_spots}
...
def xiaoYuanGF(request):
    articles = Article.objects.filter(status=1, classify=2, college=1).order_by('-id')
    hot_spots = Article.objects.filter(status=1).order_by('-id')[:5]
    data = {'articles': articles, 'hot_spots': hot_spots}
...
def xiaoYuanJY(request):
    articles = Article.objects.filter(status=1, classify=2, college=2).order_by('-id')
    hot_spots = Article.objects.filter(status=1).order_by('-id')[:5]
    data = {'articles': articles, 'hot_spots': hot_spots}
...
def xiaoYuanLX(request):
    articles = Article.objects.filter(status=1, classify=2, college=3).order_by('-id')
    hot_spots = Article.objects.filter(status=1).order_by('-id')[:5]
    data = {'articles': articles, 'hot_spots': hot_spots}
...
def xiaoYuanSJR(request):
    articles = Article.objects.filter(status=1, classify=2, college=4).order_by('-id')
    hot_spots = Article.objects.filter(status=1).order_by('-id')[:5]
    data = {'articles': articles, 'hot_spots': hot_spots}
...
def xinWen(request):
    articles = Article.objects.filter(status=1, classify=1).order_by('-id')
    hot_spots = Article.objects.filter(status=1).order_by('-id')[:5]
    data = {'articles': articles, 'hot_spots': hot_spots}
